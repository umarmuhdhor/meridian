...
import { getLessonsForPrompt, getPerformanceSummary } from "../persistence/lessons.js";
import { getDecisionSummary } from "../persistence/decision-log.js";
...
export async function agentLoop(goal, maxSteps = config.llm.maxSteps, sessionHistory = [], agentType = "GENERAL", model = null, maxOutputTokens = null, options = {}) {
  ...
  if (agentType === "SCREENER") {
    try {
      const { getWeightsSummary } = await import("../persistence/signal-weights.js");
